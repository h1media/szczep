...
//------------------------------------------------------------------------
//						BACKSTRETCH SLIDER SETTINGS
//------------------------------------------------------------------------
	/*$("#intro").backstretch([
      "http://szczep.h1media.pl/wp-content/themes/szczep/images/intro-bg3.jpg"
    , "http://szczep.h1media.pl/images/intro-bg4.jpg"
    , "http://szczep.h1media.pl/images/intro-bg5.jpg"
...
//------------------------------------------------------------------------
    $(function() {
        ...
        if(navigator.userAgent.match(/iPhone|iPad|iPod|Android|BlackBerry|IEMobile/i)) {
                BV.show('http://szczep.h1media.pl/wp-content/themes/szczep/images/screen-4.png');
        } else{
            if (!!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0) {
                BV.show('http://szczep.h1media.pl/wp-content/themes/szczep/video_bg.ogv', {doLoop:true, ambient:true});
            } else{
                BV.show('http://szczep.h1media.pl/wp-content/themes/szczep/video_bg.mp4', {doLoop:true, ambient:true, altSource:'video_bg.ogv'});
            }
